...
/**
 * Api services for the `Studentregisteration` model.
 */
@Injectable()
export class StudentregisterationApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id studentregisteration id
   *
   ...
   * This usually means the response is a `Studentregisteration` object.)
   * </em>
   */
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/:id/accessTokens/:fk";
  ...
  /**
   * Queries accessTokens of studentregisteration.
   *
   * @param {any} id studentregisteration id
   *
   * @param {object} filter 
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts accessTokens of studentregisteration.
   *
   * @param {any} id studentregisteration id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public verify(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/:id/verify";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public changePassword(oldPassword: any, newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/change-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
   ...
   * This method returns no data.
   */
  public setPassword(newPassword: any, access_token?:any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/reset-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        newPassword: newPassword
   ...
   *  - `email` – `{string}` - 
   */
  public getEmail(email: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/studentregisterations/getemail";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.Studentregisteration#getCurrent
   * @methodOf sdk.Studentregisteration
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/studentregisterations" + "/:id";
   ...
   * call to {@link sdk.Studentregisteration#login} or
   * {@link sdk.Studentregisteration#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Studentregisteration#login}
   *
  ...
  /**
   * @name sdk.Studentregisteration#isAuthenticated
   *
  ...
  /**
   * @name sdk.Studentregisteration#getCurrentId
   *
